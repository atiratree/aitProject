...
<div class="container">
    ...
    <div class="block" style="padding-bottom: 2em">
        ...
        <% if (RequestUtils.getBooleanParam(request, LoginUtils.LOGGED_IN_ATTR)) { %>
        <div class="inline smallMarginLeft pull-right">
            <button type="button" class="btn btn-default" onclick="window.location='<%=Path.ORDER_HISTORY_URL%>'">Order history</button>
        </div>
        <div class="inline smallMarginLeft pull-right">
        ...
        <div class="panel-group">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-success" style="cursor: default" disabled>
                        Already Bought
                    </button>
                    <% } else if (ShoppingUtils.isItemInSessionCart(request, type)) { %>
                    <button class="btn btn-info" id="temperatureButton" style="cursor: default" disabled>
                        Added to Cart
                    </button>
                    <%} else {%>
                    <form action="<%=Path.ADD_TO_CART_URL%>" method="post">
                        <button class="btn btn-default" name="<%=RequestParams.VISUALISATION_ID%>" value="<%=type.name()%>">Add to Cart</button>
                    </form>
                    <% }%>
                </div>
            </div>
